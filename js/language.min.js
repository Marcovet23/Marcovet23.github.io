const json_langauge = {
  italiano: [
    ...
    { id: 'footer-subtitle-text', html: 'Sviluppatore Full Stack e AI ' },
    {
      ...
      html:
        'Sono Alberto Campini ho ' +
        calcolaAnniPassati(new Date('8/23/1999')) +
        ' anni, laureato in informatica, data analyst presso <b>Reply</b>, Fouder di <b>ABC Labs</b>'
    },
    ...
    { id: 'about-section__subtitle-txt', html: 'Qualcosa su di me' },
    {
      ...
      html: 'Sono Alberto Campini, nato ad Asti il 23 agosto del <b>1999</b>. Sin da subito ho avuto le idee chiare su cosa volessi fare da grande. Ho fondato assieme a due soci la mia prima società, <b>ABC Labs</b>, nel marzo del 2021. Ho conseguito la laurea magistrale in <b>AI</b> nel 2023 e attualmente sono un AI & BI developer presso <b>Cluster Reply</b> <a onclick="openModal(\'About\')" class="more__info__about__link">Voglio saperne di più <i class="uil uil-plus active-link"></i></a>'
    },
...
function calcolaAnniPassati (dataPassata) {
  ...
  const millisecondiInUnAnno = 3156e7
